...
class Admin_applications extends Controller
{
    public function getVolAct_admin() {
		...
		if ($name == 'check')
		{
			...
			return view('profile', ['activity' => $contentVolAct, 'appl'=>$contentVolAppl, 'doctors_meet'=>$contentDoctAct, 'doct_appl'=>$contentDoctAppl]);
		}
