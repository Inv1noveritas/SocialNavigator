...
<html lang = "ru">
	...
	<body class = "Grid">
		...
		<div>
			<div class='notification' style = "margin-top: 8%;">
				
				<p style = "font-size: 27px; margin-left: 42%;">Прощайте!</p>
				<div style = "margin-top: 8%;"> <a href="./" class = "baton">Вернуться на главную страницу</a> </div>
			</div>
		</div>
		<div class = "footer">
			<div class = "number">
