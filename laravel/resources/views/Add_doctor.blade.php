...
<html lang = "ru">
	...
	<body class = "Grid">
		...
		<div>
			<form action="/result_adding_doctor" method="post" name="my_form" id="form">
			@csrf
			<fieldset>
			<legend>Добавить врача</legend><br>			
				<div class = "form_grid">			
					<div class = "form_left">			
						<div class="field">
							<label for="name">ФИО врача*:</label>
							<input type="text" id="name" name="doctor_name" pattern="^[А-Яа-яЁё\s]+$" autofocus required>
						</div>
						
						<div class="field">
							<label for="speciality">Специальность*:</label>
							<input type="text" id="speciality" name="doctor_speciality" required>
						</div>				

						<div class="field">
							<label for="job">Адрес места работы*:</label>
							<input type="text" id="job" name="doctor_job" required>
						</div>						
					</div>
					...
					<div class = "form_right">			
						<div class="field">
							...
							<input type="text" id="tel_number" name="doctor_tel_number" pattern="[+0-9]{11,12}">
						</div>
			
						<div class="field">
							<label for="login">Электронная почта:</label>
							<input type="email" id="login" name="doctor_login">
						</div>
					</div>	
				</div>
